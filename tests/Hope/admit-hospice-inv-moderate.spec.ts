...
test.describe.serial('Admit Hospice Patient - INV Moderate Impact Symptoms', () => {
  ...
  test('Step 02: Add Hospice Patient - Moderate Impact', async () => {
  ...
  test('Step 09: Add Diagnosis', async () => {
    ...
    await pages.patientProfile.addDiagnosis('Malignant', 'C509');
  ...
  test('Step 13: Admit Patient (9 days ago)', async () => {
    test.setTimeout(120000);
