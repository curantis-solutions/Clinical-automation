...
/**
 * Admit Hospice Patient - INV Mild Impact Symptoms
 *
 * This test:
 * 1. Admits a hospice patient 8 days in the past
 * 2. Validates INV alert (admission + 5 days)
 * 3. Validates HUV1 alert (admission + 15 days)
 */

test.describe('Admit Hospice Patient - INV Mild Impact Symptoms', () => {
  let patientFirstName: string;
  let patientLastName: string;
  let patientId: number | undefined;
  let admitDateFormatted: string;

  test('Admit patient and validate INV/HUV1 alerts - Mild Impact Symptoms', async ({ page }) => {
    ...
    // ============================================
    console.log('\n👤 Step 2: Add Hospice Patient - Mild Impact');
    ...
    patientLastName = `MildSym${faker.person.lastName()}`;
    ...
    await patientProfilePage.addDiagnosis('Malignant', 'C189');
    ...
    const certificationData: WrittenCertificationData = {
      ...
      role: 'MD',
      narrativeStatement: 'Patient with colon cancer, mild symptoms, prognosis 6 months or less',
    };
    ...
    // ============================================
    // Step 13: Admit Patient (8 days ago)
    // ============================================
    console.log('\n🏥 Step 13: Admit Patient (8 days ago)');

    // Admit 8 days in the past
    admitDateFormatted = DateCalculator.getPastDate(8);
    ...
    console.log('\n🎉 SUCCESS! Patient admitted with Mild Impact symptoms - Alerts validated!');
