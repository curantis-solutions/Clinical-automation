...
test.describe.serial('Admit Hospice Patient - INV Mild Impact Symptoms', () => {
  ...
  test('Step 02: Add Hospice Patient - Mild Impact', async () => {
  ...
  test('Step 09: Add Diagnosis', async () => {
    ...
    await pages.patientProfile.addDiagnosis('Malignant', 'C189');
  ...
  test('Step 13: Admit Patient (8 days ago)', async () => {
    test.setTimeout(120000);
