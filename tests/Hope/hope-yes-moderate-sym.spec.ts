...
test.describe.serial('HOPE Visit - Yes Preferences with Moderate Symptoms', () => {
  ...
  test('Step 02: Search for Patient with Moderate symptoms', async () => {
    test.setTimeout(120000);
  ...
  test('Step 04: Perform INV Visit - Yes Preferences, Moderate Symptoms', async () => {
  ...
  test('Step 07: Validate Complete HOPE Preview Report', async () => {
    ...
    await pages.hopePreview.validateCompleteHOPEPreview(HOPE_YES_MODERATE_CONFIG);
    ...
    console.log('Symptoms: Moderate Impact');
