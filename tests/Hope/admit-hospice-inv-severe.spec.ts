...
test.describe('Admit Hospice Patient - INV Severe Symptoms', () => {
  let patientFirstName: string;
  let patientLastName: string;
  let patientId: number | undefined;
  let admitDateFormatted: string;

  test('Admit patient and validate INV/HUV1 alerts - Severe Symptoms', async ({ page }) => {
    ...
    // ============================================
    console.log('\n👤 Step 2: Add Hospice Patient - Severe Symptoms');
    ...
    await patientProfilePage.addDiagnosis('Malignant', 'C341');
    ...
    // ============================================
    // Step 13: Admit Patient (11 days ago)
    // ============================================
    console.log('\n🏥 Step 13: Admit Patient (11 days ago)');
