 ...
 *
 * @example
 * // Add a primary diagnosis with defaults
 * await diagnosisWorkflow.fillDiagnosisDetails('add');
 *
 * @example
 * // Add with custom primary + secondary
 * await diagnosisWorkflow.fillDiagnosisDetails('add', {
 *   primaryDiagnosis: { searchText: 'C801', optionIndex: 0 },
 *   secondaryDiagnosis: { searchText: 'I10', optionIndex: 0 },
 * });
 *
 * @example
 * // Edit only the secondary diagnosis
 * await diagnosisWorkflow.fillDiagnosisDetails('edit', {
 *   secondaryDiagnosis: { searchText: 'J449', optionIndex: 0 },
 * }, ['secondaryDiagnosis']);
 */
